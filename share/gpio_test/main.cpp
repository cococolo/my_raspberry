...
int main (void)
{
    ...
    while(1)
    {
        ...
        gpio4->setval_gpio("1"); // GPIO17 set to input
        usleep(500000);  // wait for 0.5 seconds
        gpio4->setval_gpio("0"); // GPIO17 set to input
        /*
        ...
        {
            cout << "input pin state is Pressedn Will check input pin state again in 20ms "<<endl;
                usleep(20000);
